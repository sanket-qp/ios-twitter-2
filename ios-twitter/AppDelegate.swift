...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        if User.currentUser != nil {
            ...
            //var vc = storyboard.instantiateViewControllerWithIdentifier("NewHomeNavigationController") as UIViewController

            var vc = storyboard.instantiateViewControllerWithIdentifier("NewHomeViewController") as UIViewController
            
            //var vc = storyboard.instantiateViewControllerWithIdentifier("TempViewController") as UIViewController
